...
/// شاشة تقييم الرحلة للراكب
/// تظهر بعد انتهاء الرحلة لتقييم السائق وإضافة تعليق
class PassengerTripRatingScreen extends StatefulWidget {
  const PassengerTripRatingScreen({Key? key}) : super(key: key);

  @override
  State<PassengerTripRatingScreen> createState() => _PassengerTripRatingScreenState();
}

class _PassengerTripRatingScreenState extends State<PassengerTripRatingScreen> {
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            // رسالة التقييم
            Text(
              'كيف كانت رحلتك مع ${_driverInfo['name']}؟',
              style: TextStyle(
            ...
            Text(
              '${_driverInfo['car']} - ${_driverInfo['plate']}',
              style: TextStyle(
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildTripInfoRow('السعر:', _tripInfo['price'], isLast: true),
                ],
              ),
            ),
            const SizedBox(height: 30),
